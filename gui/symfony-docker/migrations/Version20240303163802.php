 ...
 */
final class Version20240303163802 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user_role_request ADD COLUMN read BOOLEAN NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP TABLE __temp__resource');
        $this->addSql('CREATE INDEX IDX_BC91F41656A273CC ON resource (origin_id)');
        $this->addSql('CREATE TEMPORARY TABLE __temp__user_role_request AS SELECT id, id_user_id, role_request, date_role_request FROM user_role_request');
        ...
        $this->addSql('INSERT INTO user_role_request (id, id_user_id, role_request, date_role_request) SELECT id, id_user_id, role_request, date_role_request FROM __temp__user_role_request');
