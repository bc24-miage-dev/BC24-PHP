 ...
 */
final class Version20240403083949 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__user_role_request AS SELECT id, user_id, production_site_id, role_request, date_role_request, read, description, wallet_addressst FROM user_role_request');
        $this->addSql('DROP TABLE user_role_request');
        $this->addSql('CREATE TABLE user_role_request (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, user_id INTEGER NOT NULL, production_site_id INTEGER DEFAULT NULL, role_request VARCHAR(255) NOT NULL, date_role_request DATETIME NOT NULL, read BOOLEAN NOT NULL, description CLOB NOT NULL, wallet_address VARCHAR(255) DEFAULT NULL, CONSTRAINT FK_7965666A76ED395 FOREIGN KEY (user_id) REFERENCES user (id) ON UPDATE NO ACTION ON DELETE NO ACTION NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_7965666E3A89B9B FOREIGN KEY (production_site_id) REFERENCES production_site (id) ON UPDATE NO ACTION ON DELETE NO ACTION NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO user_role_request (id, user_id, production_site_id, role_request, date_role_request, read, description, wallet_address) SELECT id, user_id, production_site_id, role_request, date_role_request, read, description, wallet_addressst FROM __temp__user_role_request');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE INDEX IDX_BC91F416E3441BD3 ON resource (current_owner_id)');
        $this->addSql('CREATE INDEX IDX_BC91F4162CB77B3E ON resource (resource_name_id)');
        $this->addSql('CREATE TEMPORARY TABLE __temp__user_role_request AS SELECT id, user_id, production_site_id, role_request, date_role_request, read, description, wallet_address FROM user_role_request');
        $this->addSql('DROP TABLE user_role_request');
        $this->addSql('CREATE TABLE user_role_request (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, user_id INTEGER NOT NULL, production_site_id INTEGER DEFAULT NULL, role_request VARCHAR(255) NOT NULL, date_role_request DATETIME NOT NULL, read BOOLEAN NOT NULL, description CLOB NOT NULL, wallet_addressst VARCHAR(255) DEFAULT NULL, CONSTRAINT FK_7965666A76ED395 FOREIGN KEY (user_id) REFERENCES user (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_7965666E3A89B9B FOREIGN KEY (production_site_id) REFERENCES production_site (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO user_role_request (id, user_id, production_site_id, role_request, date_role_request, read, description, wallet_addressst) SELECT id, user_id, production_site_id, role_request, date_role_request, read, description, wallet_address FROM __temp__user_role_request');
        $this->addSql('DROP TABLE __temp__user_role_request');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_7965666A76ED395 ON user_role_request (user_id)');
        $this->addSql('CREATE INDEX IDX_7965666E3A89B9B ON user_role_request (production_site_id)');
    }
